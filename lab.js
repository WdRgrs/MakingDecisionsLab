...
/*
  Using an if statement and a comparison operator, create code that will check if Amy or Brittani is older, and 
  then console.log '{name} is older'. Hint: Consider what will happen if they are the same age. Handle this situation.
*/
...
if (amysBirthYear === brittanisBirthYear) {
  console.log('Amy & Brittani were born in the samy year');
} else {
...
if (num < myFavoriteNumbers.length) {
  problem9 = myFavoriteNumbers[num];
  console.log(problem9);
} else {
  console.log('Pick a number less than ' + myFavoriteNumbers.length);
}
...
/* The famous FizzBuzz, Devmountain style!
  Create a for loop that iterates from 1 to 100. In this for loop, using some conditional logic, if the number your for loop is currently on is 
  divisible by 3, console.log 'Dev'. If the number is divisible by 5, console.log 'mountain'. If the number is divisible by 5 & 3, console.log 'Devmountain'. 
